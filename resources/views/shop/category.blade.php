                        ...
                        @foreach($categories as $cat)
                            <li>
                                <a href="{{ route('shop.category', $cat->slug) }}" style="
                                            ...
                                            color: {{ $cat->id === $category->id ? 'var(--primary)' : 'var(--text)' }};
                                            background: {{ $cat->id === $category->id ? 'rgb(99 102 241 / .08)' : 'transparent' }};
                ...
                @if($products->isEmpty())
                    <div class="card" style="padding: 48px; text-align: center;">
                        ...
                        <a href="{{ route('shop.index') }}" class="btn btn-primary"
                            style="display: inline-flex; margin-top: 20px;">Browse All Products</a>
                    </div>
                @else
